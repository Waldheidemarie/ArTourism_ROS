...
public abstract class RosActivity extends Activity {
    ...
    public void execute(int requestCode, int resultCode, Intent data) {
      if (resultCode == RESULT_OK) {
        if (requestCode == MASTER_CHOOSER_REQUEST_CODE) {
          ...
          if(host!=null) {
            Log.i("dataTransfer:  ",host + "~~~~~");
            if(nodeMainExecutorService == null){
              Log.i("dataTransfer:  ", "nodeMainExecutorService is Null!!!!!");
            }else{
              Log.i("dataTransfer:  ", "nodeMainExecutorService not Null!!!!!");
            }
  ...
  private final class NodeMainExecutorServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName name, IBinder binder) {
      Log.i("dataTransfer:  ", "onServiceConnected");
